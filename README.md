...
CREATE TABLE collections(address VARCHAR(128), name VARCHAR(128), symbol VARCHAR(128), initialPrice VARCHAR(128), uri VARCHAR(128), maxSupply VARCHAR(128), format VARCHAR(128), ipfsHash VARCHAR(128), PRIMARY KEY(address));
